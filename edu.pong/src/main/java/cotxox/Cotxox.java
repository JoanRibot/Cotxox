...
public class Cotxox {
	...
	public static void main(String[] args) {
		...
		System.out.println("Driver: " + carrera.getConductor().get().getNombre());
		System.out.println("Type: " + carrera.getConductor().get().getModelo());
		System.out.println("Matricula: " + carrera.getConductor().get().getMatricula());
		System.out.println("Stars: " + carrera.getConductor().get().getValoracion());
		System.out.println("From: " + carrera.getOrigen());
		System.out.println("To: " + carrera.getDestino());
	boolean ocupado = carrera.getConductor().get().isOcupado();
		if (ocupado) {
	...
	System.out.println("\n#####" + "\t Pay and Tip: \t" + "#####\n");
		...
		System.out.println("Ocupado?: " + carrera.getConductor().get().isOcupado());

	System.out.println("\n#####" + "\t Rate your driver: \t" + "#####\n");

		carrera.getConductor().get().setValoracion((byte) 5);
